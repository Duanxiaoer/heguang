...
<body>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-12">
					<ol class="breadcrumb">
					  ...
					  <li class="breadcrumb-item active"><%=newsTitle%></li>
					</ol>
				</div>
			</div>
			<!-- end row-->
    ...
    <section id="service" class="section-padding">
        <div class="auto-container">
			<p style="float: left">发布时间：<%=date%></p>
			<iframe height="100%" width="100%" src="../upload/news/<%=newsTitle%>.html"></iframe>
        </div>
        <!--- END CONTAINER -->
    </section>
    <!-- END SERVICE SECTION -->
    ...
    <script src="assets/js/canvasjs.active.js"></script>
</body>
