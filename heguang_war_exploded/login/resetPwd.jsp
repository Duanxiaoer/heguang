...
<%
    ...
    if (!pwd.equals(pwd_check)){
        ...
        if (email!=null){
            String passCheck = session.getAttribute("passCheck").toString();
            String code_forgot = session.getAttribute("code_forgot").toString();
            if (passCheck.length()>1 && passCheck.equals(code_forgot)){
                DB db = new DB();
                db.connectToDB();
