				...
				<div style="width: 100%" class="row">
					<div style="float: left;width: 25%;margin-left: 2%;margin-right: 2%">
						<div style="height: fit-content;width: fit-content;min-height: 250px;min-width: 200px"
							...
							<div class="single-doctor-info">
								<h4 id="name">封面图片</h4>
								<span id="type">大小：可变，格式为JPG</span>
					...
					<div style="float: right;width: 70%;">
						<div class="doctor-schedule">
							<div>
								<p style="float: left;font-size: larger;color: black"><strong>新闻标题：</strong></p>
								<input style="float: left" type="text" name="newsTittle" required>
								<p style="margin-left: 5px;float: left;font-size: larger;color: black"><strong>时间：</strong></p>
								<input style="float: left" type="date" name="date" required>
							</div>
							<br>
							<hr>
							<div>
								<p style="float: left;font-size: larger;color: black"><strong>概括：</strong></p>
								<textarea style="width: 50%;height: 20%;" maxlength="150" name="summary" required>

								</textarea>
							</div>
							<br>
							<hr STYLE="margin-top: 5px">
							<h4>请将Word文件保存，并将文件名改为新闻标题，然后另存为html文件。最后上传</h4>
							<hr>
							<div>
								<p style="float: left;font-size: larger;color: black"><strong>新闻html文件：</strong></p>
								<input style="border-style: solid;color: #F16272;float: left;" class="btn" type="file" name="newsFile" placeholder="新闻html文件" required>
								<br><hr>
								<p style="float: left;font-size: larger;color: black"><strong>资源文件夹：</strong></p>
								<input style="border-style: solid;color: #F16272;float: left;" class="btn" type="file" multiple webkitdirectory name="newsDirectory" placeholder="资源文件夹" required>
