...
<%
    ...
    int status = db.checkAdmin(email,pwd);
    String adminName = db.getUsername();
    response.setCharacterEncoding("utf-8");

    switch (status){
        case 0:
            writer.print("<script>alert('身份错误！');window.history.back()</script>");
            break;
        case 1:
        ...
        case 2:
            ...
            httpSession.setAttribute("admin",adminName);
            writer.print("<script>window.location='../admin/home_menu.html'</script>");
            break;
    }
    writer.flush();
    writer.close();
