                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-8 col-sm-8 col-12">
                            <div class="home-single-slide-dec">
                                <p>简介</p>
                                <h4>四川和光临床心理学研究院</h4>
                                <h4>成立于2016年9月，是合法注册的临床心理学专业研究机构</h4>
                                <a href="doctors.jsp" style="color: whitesmoke"><span><i class="icofont icofont-plus"></i> 专业团队</span></a>
                                <a href="appointment.jsp" class="home-btn-1">立即咨询</a>
                ...
                <div class="auto-container">
                    <div class="row">
                        <div class="col-lg-7 col-md-8 col-sm-8 col-12">
                            <div class="home-single-slide-dec">
                                <p>总体愿景</p>
                                <h4>致力推动地区临床心理学事业的发展</h4>
                                <h4>与美国、加拿大、以色列等国家的多个精神分析机构以及国内的多所高校、医院、协会等保持密切的专业合作与交流</h4>
        ...
        <div class="row text-center">
            <div class="col-lg-3 col-md-6 col-sm-12 col-12 mb-lg-0 mb-md-4 mb-sm-4 mb-4">
                <div class="single-about">
                    ...
                    <h5>使命</h5>
                    <p>研究院以促进大众心理健康和构建和谐社会为愿景，集国内外精神分析领域的专业资源与专业人才之力，努力发展成为国内一流的临床服务、人才培养和学术交流的中心。</p>
                </div>
            </div>
            <!-- end single about -->
            <div class="col-lg-3 col-md-6 col-sm-12 col-12 mb-lg-0 mb-md-4 mb-sm-4 mb-4">
                <div class="single-about">
                    ...
                    <h5>起源</h5>
                    <p>和光一词来自于“和光同尘”，出自《道德经》中的“和其光，同其尘”，是有“和其光，同其尘”之心灵，对人有宽恕之量，对谤语要有忍辱之量，对忠言要有虚受之量，对事物要有容纳之量。研究院的现任院长姜启壮在拜访一位老前辈时，老前辈送了他一把扇子，上面写着“和光同尘”，在创办研究院之时，他想到精神分析在中国也是能“和光”，也是能“同尘”的。</p>
                </div>
            </div>
            <!-- end single about -->
            <div class="col-lg-3 col-md-6 col-sm-12 col-12 mb-lg-0 mb-md-4 mb-sm-4 mb-4">
            ...
            <div class="row">
                <div class="col-lg-7 text-center mx-auto">
                    <div class="section-title">
                        ...
                        <span class="line"></span>
                        <p>研究院目前共有咨询室6间，会议室一间，档案室一间，占地328平方。</p>
                    </div>
                </div>
                <!-- end section title -->
            </div>
