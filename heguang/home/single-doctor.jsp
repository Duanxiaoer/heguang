                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="doctor-schedule">
                            ...
                            <br>
                            <br>
                            <h4>咨询时间（本月）</h4>---<span style="color:red;">红色</span>日期不可预约
                            <br>
                            ---<span style="color:green;">绿色</span>日期可预约
                            <br>
                            ---<span style="color:blue;">蓝色</span>日期预约已满
                                    ...
                                    <%
                                        ...
                                        while (count > 0) {
                                            ...
                                            if (ca.getTime().compareTo(nowDate) > 0) {
                                                ...
                                                JSONArray jsonArray = db.queryZxsTimeByTime(zxsEmail,""+tempDate);
                                                ...
                                                if(jsonArray.size()==0){
                                                    JSONArray jsonArray1=db.queryZxsTimeByTime(zxsEmail,xqa);
                ...
                if (result.length<1) {
                    ...
                    for (var i=0;i<result.length;++i){
                        ...
                        if (result[i].bz === "") {
                            ...
                            alltime.innerHTML += "<input type='button' style='background-color: greenyellow' value='"+ks+":00-"+js+":00,"+"已满"+"' >";
                        }
                    }
                }
            }
