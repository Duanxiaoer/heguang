...
<div style="text-align: center" class="gmap_canvas">
    <div></div>
    <div>
        <iframe src="http://www.google.cn/maps/embed?pb=!1m18!1m12!1m3!1d7139.694444185411!2d104.00450026938672!3d30.67368976223225!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x36efc3570f118015%3A0xb3644806f8120723!2sXicun+Courtyard!5e0!3m2!1sen!2scn!4v1548170925271" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
    </div>
    <div></div>
</div>
<!-- END GOOGLE MAP -->
                    ...
                    <form action="submitContact.jsp" method="post">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                <label>想问的问题</label>
                                <textarea rows="6" name="message" class="form-control" id="cmessage" placeholder="您想咨询的问题。。。" required="required"></textarea>
                            </div>
