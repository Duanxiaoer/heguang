            ...
            <div class="row text-center ">
                <div class="portfolio-slider owl-carousel owl-theme">
                    <%
                        ...
                        ResultSet resultSet = db.queryNews();
                        try {
                    ...
                    %>
                    <div style="margin-left: 10px" class="single-gallery-item">
                        <div class="single-gallery single-gallery-first">
                            <img class="img-fluid" src="../upload/news/<%=newsTitle%>.jpg" alt="" />
                            <div class="single-gallery">
                                <div class="single-gallery-inner">
                                    <h5><%=newsTitle%></h5>
                                    <p><%=date%></p>
                                    <a href="../upload/news/<%=newsTitle%>.jpg" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont icofont-expand"></i></a>
                                </div>
                            </div>
                        </div>
                        <div style="text-align: left;margin-top: 10px;margin-bottom: 20px" >
                            <div style="margin-left: 5%">
                                ...
                                <a href="single-news.jsp?newsTitle=<%=newsTitle%>&date=<%=date%>" class="blog-home-rmbtn">了解详情 <i class="icofont icofont-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <%
